...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'VuongIT MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://www.vietnamworks.com/hrinsider/wp-content/uploads/2023/12/hinh-nen-may-tinh-dep-a-35-1.jpg',
      ...
      },
      {
        ...
        /*
        |* phia FE tao 1 card dac biet: placeHolderCard, klq toi BE
        |* Card db nay se duoc an o giao dien nguoi dung
        */
